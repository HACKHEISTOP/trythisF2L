...
class Telegram:
    ...
    FILE_PIC = env.get('FILE_PIC', "https://files.catbox.moe/g02k3k.jpg")
    START_PIC = env.get('START_PIC', "https://files.catbox.moe/g02k3k.jpg")
    VERIFY_PIC = env.get('VERIFY_PIC', "https://files.catbox.moe/g02k3k.jpg")
    MULTI_CLIENT = False
